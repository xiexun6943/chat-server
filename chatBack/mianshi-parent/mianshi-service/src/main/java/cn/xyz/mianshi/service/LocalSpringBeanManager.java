...
import cn.xyz.commons.autoconfigure.KApplicationProperties.ReceiptQR;
...
public class LocalSpringBeanManager {
	...
	@Autowired(required=false)
	private ReceiptQR receiptQR;
	public ReceiptQR getReceiptQR() {
		return receiptQR;
	}
	...
	@Autowired
	private IpAddressManagerImpl ipAddressManager;
	public IpAddressManagerImpl getIpAddressManager() {
		return ipAddressManager;
	}


	@Autowired
	private UserOperationLogImpl userOperationLog;
	public UserOperationLogImpl getUserOperationLog() {
		return userOperationLog;
	}

	@Autowired
	private BackIpWhiteImpl ipBlack;
	public BackIpWhiteImpl getBackIpWhiteManager() {
		return ipBlack;
	}
