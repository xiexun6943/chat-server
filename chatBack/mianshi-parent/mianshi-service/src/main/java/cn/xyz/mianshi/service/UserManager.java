...
public interface UserManager {
	...
	Map<String, Object> login(UserExample example,HttpServletRequest request);
	...
	Map<String, Object> registerIMUser(UserExample example,HttpServletRequest request) throws Exception;
