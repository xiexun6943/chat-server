...
import cn.xyz.commons.constants.ImConstants;
...
//        System.out.println("userId"+userId+"addUser用户注册>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"+example.getPassword());
...
//    public UserOperationLog saveUserOperationLog(User user,UserExample example,HttpServletRequest request,int logtype) {
//        UserOperationLog loginLog =null;
//        if(user==null){
//            loginLog = new UserOperationLog();
