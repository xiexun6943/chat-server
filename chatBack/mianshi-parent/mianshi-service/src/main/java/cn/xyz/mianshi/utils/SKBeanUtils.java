...
public class SKBeanUtils implements ApplicationContextAware {
	...
	public static UserOperationLogImpl getUserOperationLogManager(){
		return getLocalSpringBeanManager().getUserOperationLog();
	}

	public static BackIpWhiteImpl getIpBlackManager(){
		return getLocalSpringBeanManager().getBackIpWhiteManager();
	}
}
