...
public class DeviceUtils {
    ...
    private static String[] pcHeaders = new String[] { "Windows 98", "Windows ME", "Windows 2000", "Windows XP",
            "Windows NT", "Ubuntu" ,"Windows 10" ,"Windows 8" ,"Windows 8.1" ,"Windows 7" ,"PostmanRuntime"};
     ...
     */
    public static Map<String,String> isMobileDevice(HttpServletRequest request) {
        ...
        for (int i = 0; !mobileFlag && userAgent != null && !"".equals(userAgent.trim())
            ...
            if (userAgent.contains(mobileUserAgents[i])) {
                map.put("deviceName",mobileUserAgents[i]);
                mobileFlag = true;
                break;
            }
        }
        for (int i = 0; userAgent != null && !"".equals(userAgent.trim()) && i < pcHeaders.length; i++) {
            if (userAgent.contains(pcHeaders[i])) {
                map.put("deviceName",pcHeaders[i]);
                pcFlag = true;
                break;
            }
        }
