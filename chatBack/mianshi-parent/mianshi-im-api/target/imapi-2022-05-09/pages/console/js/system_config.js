...
function fillParameter(data){
    ...
    $(".phoneSearch").val(1/*data.phoneSearch*/);// 使用Google地图
    $(".nameSearch").val(1/*data.nameSearch*/);// 使用Google地图
...
layui.use(['form','jquery',"layer"],function() {
    ...
    form.on("submit(systemConfig)",function(data){
       ...
       systemConfig.giftRatio = $(".giftRatio").val();
        ...
        systemConfig.phoneSearch =1 /*$(".phoneSearch").val()*/;
        systemConfig.nameSearch = 1/*$(".nameSearch").val()*/;
